                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        if ($idanggota <> "") { ?>
                            ...
                            <div class="col-md-1 col-xs-12">
                                <div class="form-group">
                                    <button type="submit" onclick="simpantransaksi(<?php echo $idanggota; ?>)" name="submit" value="new" class="btn btn-warning"><i class="fa fa-save"></i> Selesaikan Peminjaman</button>
...
<script>
            ...
            success: function(msg) {
                ...
                if (data["isError"] == 1) {
                    ...
                    setInterval(function() {
                        location.href = "home.php?module=peminjaman&idanggota=" + input.value;
                        barcodebuku.focus();
                    }, 500);
                }
            },
    ...
    function hapus(idbuku) {
        ...
        if (r === true) {
            ...
            $.ajax({
                url: "module/mpeminjaman/inputpinjam.php?hapus=" + idbuku + "&anggota=" + input.value,
                type: "post",
                data: $(this).serialize(),
                success: function(msg) {
                    data = $.parseJSON(msg);
